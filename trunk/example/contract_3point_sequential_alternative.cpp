...
//   seqProp_d.changeBoundaryConditions_uniformToFixed(t_op, timeslice_boundary);
  ...
  Core::Correlator C3p_d1(L,T, new Core::Field< Dirac::Matrix >(L,T));
  //= Contract::proton_twopoint(uProp, uProp, seqProp_d, Base::proj_NO_PROJECTOR);
  Core::Correlator C3p_u1(C3p_d1);
  Core::Correlator C3p_u2(C3p_d1);
