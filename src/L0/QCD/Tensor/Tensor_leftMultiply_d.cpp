...
QCD::Tensor &QCD::Tensor::leftMultiply(SU3::hcMatrix const &mat)
{
  ...
  for (size_t idx=0; idx<144; idx+=36)
  {
    std::transform(d_data + idx,      d_data + idx + 12, result0 + idx,
                   std::bind1st(std::multiplies< std::complex< double > >(), mat_T.d_data[0]));
    std::transform(d_data + idx + 12, d_data + idx + 24, result1 + idx,
                   std::bind1st(std::multiplies< std::complex< double > >(), mat_T.d_data[1]));
    std::transform(d_data + idx + 24, d_data + idx + 36, result2 + idx,
                   std::bind1st(std::multiplies< std::complex< double > >(), mat_T.d_data[2]));
    std::transform(d_data + idx,      d_data + idx + 12, result0 + idx + 12,
                   std::bind1st(std::multiplies< std::complex< double > >(), mat_T.d_data[3]));
    std::transform(d_data + idx + 12, d_data + idx + 24, result1 + idx + 12,
                   std::bind1st(std::multiplies< std::complex< double > >(), mat_T.d_data[4]));
    std::transform(d_data + idx + 24, d_data + idx + 36, result2 + idx + 12,
                   std::bind1st(std::multiplies< std::complex< double > >(), mat_T.d_data[5]));
    std::transform(d_data + idx,      d_data + idx + 12, result0 + idx + 24,
                   std::bind1st(std::multiplies< std::complex< double > >(), mat_T.d_data[6]));
    std::transform(d_data + idx + 12, d_data + idx + 24, result1 + idx + 24,
                   std::bind1st(std::multiplies< std::complex< double > >(), mat_T.d_data[7]));
    std::transform(d_data + idx + 24, d_data + idx + 36, result2 + idx + 24,
                   std::bind1st(std::multiplies< std::complex< double > >(), mat_T.d_data[8]));
  }
