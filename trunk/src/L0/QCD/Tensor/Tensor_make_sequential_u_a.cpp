...
namespace QCD
{
  ...
  void make_sequential_u(Tensor &result, Tensor const &D, Tensor const &U, Base::BaryonPropagatorProjector const projector)
  {
    ...
    for (size_t idx=0; idx<alpha_f_perms.size(); idx++)
    {
      ...
      std::transform(rrC, rrC+16, tmp, rrC, std::plus< std::complex< double> >());
      bbD.outer_product(ggU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rrC, rrC+16, tmp, rrC, std::plus< std::complex< double> >());
      bgD.outer_product(gbU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rrC, rrC+16, tmp, rrC, std::minus< std::complex< double> >());
      gbD.outer_product(bgU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rrC, rrC+16, tmp, rrC, std::minus< std::complex< double> >());
      ggD.outer_product(bbU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rrC, rrC+16, tmp, rrC, std::plus< std::complex< double> >());
      bbD.outer_product(ggU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rrC, rrC+16, tmp, rrC, std::plus< std::complex< double> >());
      bgD.outer_product(gbU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rrC, rrC+16, tmp, rrC, std::minus< std::complex< double> >());
      gbD.outer_product(bgU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rrC, rrC+16, tmp, rrC, std::minus< std::complex< double> >());
      ggD.outer_product(bbU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rrC, rrC+16, tmp, rrC, std::plus< std::complex< double> >());
      ...
      std::transform(rgC, rgC+16, tmp, rgC, std::plus< std::complex< double> >());
      brD.outer_product(gbU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rgC, rgC+16, tmp, rgC, std::plus< std::complex< double> >());
      bbD.outer_product(grU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rgC, rgC+16, tmp, rgC, std::minus< std::complex< double> >());
      grD.outer_product(bbU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rgC, rgC+16, tmp, rgC, std::minus< std::complex< double> >());
      gbD.outer_product(brU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rgC, rgC+16, tmp, rgC, std::plus< std::complex< double> >());
      brD.outer_product(gbU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rgC, rgC+16, tmp, rgC, std::plus< std::complex< double> >());
      bbD.outer_product(grU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rgC, rgC+16, tmp, rgC, std::minus< std::complex< double> >());
      grD.outer_product(bbU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rgC, rgC+16, tmp, rgC, std::minus< std::complex< double> >());
      gbD.outer_product(brU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rgC, rgC+16, tmp, rgC, std::plus< std::complex< double> >());
      ...
      std::transform(rbC, rbC+16, tmp, rbC, std::plus< std::complex< double> >());
      bgD.outer_product(grU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rbC, rbC+16, tmp, rbC, std::plus< std::complex< double> >());
      brD.outer_product(ggU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rbC, rbC+16, tmp, rbC, std::minus< std::complex< double> >());
      ggD.outer_product(brU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rbC, rbC+16, tmp, rbC, std::minus< std::complex< double> >());
      grD.outer_product(bgU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rbC, rbC+16, tmp, rbC, std::plus< std::complex< double> >());
      bgD.outer_product(grU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rbC, rbC+16, tmp, rbC, std::plus< std::complex< double> >());
      brD.outer_product(ggU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rbC, rbC+16, tmp, rbC, std::minus< std::complex< double> >());
      ggD.outer_product(brU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rbC, rbC+16, tmp, rbC, std::minus< std::complex< double> >());
      grD.outer_product(bgU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(rbC, rbC+16, tmp, rbC, std::plus< std::complex< double> >());
      ...
      std::transform(grC, grC+16, tmp, grC, std::plus< std::complex< double> >());
      bgD.outer_product(rbU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(grC, grC+16, tmp, grC, std::plus< std::complex< double> >());
      bbD.outer_product(rgU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(grC, grC+16, tmp, grC, std::minus< std::complex< double> >());
      rgD.outer_product(bbU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(grC, grC+16, tmp, grC, std::minus< std::complex< double> >());
      rbD.outer_product(bgU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(grC, grC+16, tmp, grC, std::plus< std::complex< double> >());
      bgD.outer_product(rbU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(grC, grC+16, tmp, grC, std::plus< std::complex< double> >());
      bbD.outer_product(rgU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(grC, grC+16, tmp, grC, std::minus< std::complex< double> >());
      rgD.outer_product(bbU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(grC, grC+16, tmp, grC, std::minus< std::complex< double> >());
      rbD.outer_product(bgU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(grC, grC+16, tmp, grC, std::plus< std::complex< double> >());
      ...
      std::transform(ggC, ggC+16, tmp, ggC, std::plus< std::complex< double> >());
      bbD.outer_product(rrU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(ggC, ggC+16, tmp, ggC, std::plus< std::complex< double> >());
      brD.outer_product(rbU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(ggC, ggC+16, tmp, ggC, std::minus< std::complex< double> >());
      rbD.outer_product(brU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(ggC, ggC+16, tmp, ggC, std::minus< std::complex< double> >());
      rrD.outer_product(bbU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(ggC, ggC+16, tmp, ggC, std::plus< std::complex< double> >());
      bbD.outer_product(rrU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(ggC, ggC+16, tmp, ggC, std::plus< std::complex< double> >());
      brD.outer_product(rbU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(ggC, ggC+16, tmp, ggC, std::minus< std::complex< double> >());
      rbD.outer_product(brU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(ggC, ggC+16, tmp, ggC, std::minus< std::complex< double> >());
      rrD.outer_product(bbU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(ggC, ggC+16, tmp, ggC, std::plus< std::complex< double> >());
      ...
      std::transform(gbC, gbC+16, tmp, gbC, std::plus< std::complex< double> >());
      brD.outer_product(rgU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(gbC, gbC+16, tmp, gbC, std::plus< std::complex< double> >());
      bgD.outer_product(rrU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(gbC, gbC+16, tmp, gbC, std::minus< std::complex< double> >());
      rrD.outer_product(bgU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(gbC, gbC+16, tmp, gbC, std::minus< std::complex< double> >());
      rgD.outer_product(brU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(gbC, gbC+16, tmp, gbC, std::plus< std::complex< double> >());
      brD.outer_product(rgU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(gbC, gbC+16, tmp, gbC, std::plus< std::complex< double> >());
      bgD.outer_product(rrU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(gbC, gbC+16, tmp, gbC, std::minus< std::complex< double> >());
      rrD.outer_product(bgU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(gbC, gbC+16, tmp, gbC, std::minus< std::complex< double> >());
      rgD.outer_product(brU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(gbC, gbC+16, tmp, gbC, std::plus< std::complex< double> >());
      ...
      std::transform(brC, brC+16, tmp, brC, std::plus< std::complex< double> >());
      gbD.outer_product(rgU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(brC, brC+16, tmp, brC, std::plus< std::complex< double> >());
      ggD.outer_product(rbU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(brC, brC+16, tmp, brC, std::minus< std::complex< double> >());
      rbD.outer_product(ggU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(brC, brC+16, tmp, brC, std::minus< std::complex< double> >());
      rgD.outer_product(gbU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(brC, brC+16, tmp, brC, std::plus< std::complex< double> >());
      gbD.outer_product(rgU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(brC, brC+16, tmp, brC, std::plus< std::complex< double> >());
      ggD.outer_product(rbU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(brC, brC+16, tmp, brC, std::minus< std::complex< double> >());
      rbD.outer_product(ggU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(brC, brC+16, tmp, brC, std::minus< std::complex< double> >());
      rgD.outer_product(gbU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(brC, brC+16, tmp, brC, std::plus< std::complex< double> >());
      ...
      std::transform(bgC, bgC+16, tmp, bgC, std::plus< std::complex< double> >());
      grD.outer_product(rbU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(bgC, bgC+16, tmp, bgC, std::plus< std::complex< double> >());
      gbD.outer_product(rrU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(bgC, bgC+16, tmp, bgC, std::minus< std::complex< double> >());
      rrD.outer_product(gbU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(bgC, bgC+16, tmp, bgC, std::minus< std::complex< double> >());
      rbD.outer_product(grU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(bgC, bgC+16, tmp, bgC, std::plus< std::complex< double> >());
      grD.outer_product(rbU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(bgC, bgC+16, tmp, bgC, std::plus< std::complex< double> >());
      gbD.outer_product(rrU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(bgC, bgC+16, tmp, bgC, std::minus< std::complex< double> >());
      rrD.outer_product(gbU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(bgC, bgC+16, tmp, bgC, std::minus< std::complex< double> >());
      rbD.outer_product(grU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(bgC, bgC+16, tmp, bgC, std::plus< std::complex< double> >());
      ...
      std::transform(bbC, bbC+16, tmp, bbC, std::plus< std::complex< double> >());
      ggD.outer_product(rrU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(bbC, bbC+16, tmp, bbC, std::plus< std::complex< double> >());
      grD.outer_product(rgU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(bbC, bbC+16, tmp, bbC, std::minus< std::complex< double> >());
      rgD.outer_product(grU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(bbC, bbC+16, tmp, bbC, std::minus< std::complex< double> >());
      rrD.outer_product(ggU, tmp, Dirac::order_BOTH_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(bbC, bbC+16, tmp, bbC, std::plus< std::complex< double> >());
      ggD.outer_product(rrU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(bbC, bbC+16, tmp, bbC, std::plus< std::complex< double> >());
      grD.outer_product(rgU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(bbC, bbC+16, tmp, bbC, std::minus< std::complex< double> >());
      rgD.outer_product(grU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(bbC, bbC+16, tmp, bbC, std::minus< std::complex< double> >());
      rrD.outer_product(ggU, tmp, Dirac::order_FIRST_OUTER_DELTA, alpha_i, alpha_f);
      std::transform(bbC, bbC+16, tmp, bbC, std::plus< std::complex< double> >());
