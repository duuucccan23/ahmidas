...
void Tool::IO::load(Core::StochasticPropagator< 1 > *sPropagator, std::vector< std::string> const &filenames, filetype type)
{
  switch(type) {
  case fileSCIDAC :
      loadScidac(sPropagator, filenames);
...
void Tool::IO::load(Core::StochasticPropagator< 1 > *sPropagator, std::vector< std::string> const &filenames, filetype type, size_t const precision)
{
  switch(type) {
  case fileSCIDAC :
      loadScidac(sPropagator, filenames, precision);
